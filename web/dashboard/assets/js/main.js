    ...
    $(document).ready(function () {
        ...
        const enableLightMode = () => {
            ...
            if ($('.theme-color-btn').hasClass('light-mode')) {
                ...
                $('.header .main-logo .logo-big img, .mobile-logo img, .logo img').attr('src', 'assets/images/logo-black.html');
            } else {
        ...
        const disableLightMode = () => {
            ...
            if (!$('.theme-color-btn').hasClass('light-mode')) {
                ...
                $('.header .main-logo .logo-big img, .mobile-logo img, .logo img').attr('src', 'assets/images/logo-big.html');
            } else {
                $('.theme-color-btn').html('<i class="fa-light fa-cloud-moon"></i>');
                $('#lightTheme').addClass('active').parent().siblings().find('.dashboard-icon').removeClass('active');
            }
        ...
        const disableDarkMode = () => {
            ...
            if($('body').hasClass('light-theme')) {
                $('.header .main-logo .logo-big img').attr('src', 'assets/images/logo-black.html');
                $('.theme-color-btn').addClass('light-mode');
            }
            if ($('.theme-color-btn').hasClass('light-mode')) {
                $('.theme-color-btn').html('<i class="fa-light fa-cloud-moon"></i>');
        ...
        $('#dirRtl').on('click', function () {
            ...
            $('html').attr('dir', 'rtl');
            $('#rtlStyle').attr('href', 'assets/css/rtl-style.html');
